...
func (r *stubUserRepo) Update(context.Context, *query.Builder, query.Column, any) (int64, error) {
	panic("not used")
}
func (r *stubUserRepo) Updates(context.Context, *query.Builder, any) (int64, error) {
	panic("not used")
}
func (r *stubUserRepo) Delete(context.Context, *query.Builder) (int64, error) { panic("not used") }
func (r *stubUserRepo) Find(context.Context, *query.Builder) ([]*model.User, error) {
	panic("not used")
}
func (r *stubUserRepo) First(context.Context, *query.Builder) (*model.User, error) {
	panic("not used")
}
func (r *stubUserRepo) Take(context.Context, *query.Builder) (*model.User, error) {
	panic("not used")
}
func (r *stubUserRepo) Last(context.Context, *query.Builder) (*model.User, error) {
	panic("not used")
}
func (r *stubUserRepo) Count(context.Context, *query.Builder) (int64, error) {
	r.countCalled++
	return r.count, r.countErr
}
func (r *stubUserRepo) Pluck(context.Context, *query.Builder, query.Column, any) error {
	panic("not used")
}
